...
<template>
  <div>
    <div id="movieSelectionContainer" class="grid-col-span-full">
      <label id="label">Select A Movie From Below
        <!-- or <a href="search.html">Search</a> -->
      </label>
      <br>
    ...
    <div v-if="movie">
      ...
      <img :src="`https://image.tmdb.org/t/p/w500${movie.poster_path}`" id="poster" alt="" class="grid-col-span-2">
      <iframe
